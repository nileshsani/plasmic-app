...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: GAIxP9X3mGYVUQ/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__mzqH8)}
            role={"img"}
