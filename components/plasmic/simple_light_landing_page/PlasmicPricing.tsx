...
import Plan from "../../Plan"; // plasmic-import: vfS-oqIMzvMglX/component
...
import Faq from "../../Faq"; // plasmic-import: r9N4HvUtuKxvwd/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: -RsJZYWYLnzRnX/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__bkMu2)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__n8PfO)}
              subtitle={
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__bOcK3)}
            >
              <Plan
                className={classNames("__wab_instance", sty.plan___2V3O)}
                price={
                  <div
                    className={classNames(
                      defaultcss.all,
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__ghzd0)}
                description={
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__qsmkL)}
                  >
                    <Bullet
                      className={classNames(
                        "__wab_instance",
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan___4TJt)}
                name={"Enterprise"}
                price={
                  <div
                    className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__s3AOc)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__hx32X)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__zDzAa)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__dEfmD)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
