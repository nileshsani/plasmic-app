...
import BaseCard from "../../BaseCard"; // plasmic-import: ZwAgV8A2IsygPp/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: vfS-oqIMzvMglX/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__fz1Yv)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__qfIo2)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__szBq4)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__xrg89)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__iHvLo)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__aNc59)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__kA0Np)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
