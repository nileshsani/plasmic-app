...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: 2OD-jdX5WzYi4/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg___11ZUh)}
              role={"img"}
            />
          ),
