...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: r9N4HvUtuKxvwd/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox___8Rwcr)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__a9Xh)}>
          <div className={classNames(defaultcss.all, sty.freeBox__kdUu)}>
            {p.renderPlasmicSlot({
