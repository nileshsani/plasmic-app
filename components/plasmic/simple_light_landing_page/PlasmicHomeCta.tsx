...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: shWxgBNdQl-u-/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: uWDJI9sB4DY2IZ/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__s5Sq)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__rPlO)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.freeBox__gMz8U)}>
          <SphereIcon
