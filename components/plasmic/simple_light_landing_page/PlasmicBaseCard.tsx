...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: ZwAgV8A2IsygPp/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox___2IGfD, {
          [sty.freeBox__long___2IGfDirOjn]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__muaRq, {
            [sty.freeBox__long__muaRqirOjn]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__s8KXx)}
                role={"img"}
              />
            ),
