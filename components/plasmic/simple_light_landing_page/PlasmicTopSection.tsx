...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: WfFCgqZ-qzZgh/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__sq1F2)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__nI7)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__aqbbk)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__gQpna)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__vxiHb)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__iSdf6)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.freeBox__xxbgb)}>
          <img
