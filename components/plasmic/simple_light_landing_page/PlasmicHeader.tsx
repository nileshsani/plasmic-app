...
import * as sty from "./PlasmicHeader.module.css"; // plasmic-import: 44ZR4WMrh4kuH/css
...
function PlasmicHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__bP9W)}
        ...
        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__je5Et)}
        ...
        <LinkButton
          className={classNames("__wab_instance", sty.linkButton__xIFkI)}
          text={"Sign in"}
          type={"small" as const}
        />
