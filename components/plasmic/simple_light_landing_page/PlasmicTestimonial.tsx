...
import Avatar from "../../Avatar"; // plasmic-import: GAIxP9X3mGYVUQ/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: r8kO_MTbhPBGsK/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: GqKX-3x1VlHPjB/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__aTtal)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__hm2Rr)}
        >
          <div
            className={classNames(
              defaultcss.all,
