...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: RqlhVybYf0LbI/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__mgs4B, {
            [sty.freeBox__long__mgs4BqHEbF]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          <div
            className={classNames(defaultcss.all, sty.freeBox__yjdhY, {
              [sty.freeBox__long__yjdhYqHEbF]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__nRx)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__xn4Dn, {
          [sty.freeBox__long__xn4DnqHEbF]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__uzppB, {
            [sty.freeBox__long__uzppBqHEbF]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___7U9ZG)}
                role={"img"}
              />
            ),
